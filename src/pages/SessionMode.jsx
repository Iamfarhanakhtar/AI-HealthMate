            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <GlassPanel className="p-5 flex flex-col gap-3">
                  <span className="material-symbols-outlined text-primary text-3xl">pest_control</span>
                ...
                <GlassPanel className="p-5 flex flex-col gap-3">
                  <span className="material-symbols-outlined text-[#36ffc4] text-3xl">water_drop</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <GlassPanel className="p-4 border-l-4 border-l-red-500/40">
                  <h4 className="font-title-md font-bold text-secondary text-[15px] flex items-center gap-2">
                    <span className="material-symbols-outlined text-red-400 text-lg">medical_services</span>
                    Snake Bites Care
                  </h4>
            ...
            >
              ...
              {!quizStarted ? (
                <GlassPanel className="p-6 text-center">
                  <span className="material-symbols-outlined text-primary text-4xl p-3 bg-white/5 rounded-full mb-4">
                    quiz
                  </span>
                ...
                <GlassPanel className="p-6 text-center">
                  <span className="material-symbols-outlined text-4xl text-[#36ffc4] mb-3">check_circle</span>
